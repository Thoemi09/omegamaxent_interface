...
#parameter file that can be modified by the user
#user_params_file="OmegaMaxEnt_TRIQS_params.dat"

#parameter file generated by compute_GfReFreq() defined below (overwritten at every execution)
...
def compute_GfReFreq(G, ERR=0, grid_params=[], name="$G^R(\omega)$", interactive_mode=True, save_figures_data=True, inv_sym=False, mu=1, nu=1,):
